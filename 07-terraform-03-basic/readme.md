...
Changes to Outputs:
  ...
  + caller_user = "---"
  ```
![Screenshot](https://github.com/Smarzhic/netology/blob/main/07-terraform-03-basic/2.png) 
![Screenshot](https://github.com/Smarzhic/netology/blob/main/07-terraform-03-basic/3.png) 
